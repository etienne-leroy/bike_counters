...
def get_estimator():
    ...
    regressor = LGBMRegressor(
        n_estimators=1500,
        learning_rate=0.03,  # Réduction du learning rate
        max_depth=12,  # Augmentation pour capturer plus de patterns
        min_child_weight=3,
        subsample=0.8,
        colsample_bytree=0.8,
        reg_alpha=1,  # Ajout d'une régularisation L1
...
results.to_csv("submission_v4.csv", index=False)
print("Fichier de soumission créé : submission_v4.csv")
