...
def get_estimator():
    ...
    # Ajout d'un imputeur pour gérer les NaN
    imputer = SimpleImputer(strategy="mean")  # Remplace les NaN par la moyenne

    # Ajout de PolynomialFeatures avec imputation
    ...
    # Nouvelle optimisation des hyperparamètres LightGBM
...
print("Fichier de soumission créé : submission_v7.csv")
